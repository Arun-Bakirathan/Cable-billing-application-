...
<script>
	...
	$('#new_course').click(function(){
		uni_modal("New package and bill Entry","manage_course.php",'large')
		
	})

	$('.edit_course').click(function(){
		uni_modal("New package and bill Entry","manage_course.php?id="+$(this).attr('data-id'),'large')
		
	})
	$('.delete_course').click(function(){
		_conf("Are you sure to delete this package?","delete_course",[$(this).attr('data-id')])
	})
