			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Customer package details</b>
...
<script>
	...
	$('#new_fees').click(function(){
		uni_modal("Register new customer package ","manage_fee.php","mid-large")
		
	})
	$('.edit_fees').click(function(){
		uni_modal("Manage customer's Register Details","manage_fee.php?id="+$(this).attr('data-id'),"mid-large")
